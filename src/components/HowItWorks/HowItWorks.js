    ...
    return (
        <div id="how-it-works"
            ...
            <h5 className="text-center">
                Tap our network of 600K workers
            </h5>
            ...
            <div className="container mt-5">
                <div className="row">
                    <Column 
                        Caption="Business post shifts for positions they need, up to a few hours in advance."
                        ...
                        fill2="#B4E0FA"/>
                    <Column 
                        Caption="Vetted workers accept shifts that fit their schedule."
                        ...
                        />
                    <Column 
                        Caption="We handle the rest including paperwork, insurance, and payments."
                        d="M24 44C35.0457 44 44 35.0457 44 24C44 12.9543 35.0457 4 24 4C12.9543 4 4 12.9543 4 24C4 35.0457 12.9543 44 24 44Z"
                        fill="#084E8A"
                        d2="M22 22V14C22 12.8954 22.8954 12 24 12C25.1046 12 26 12.8954 26 14V22H34C35.1046 22 36 22.8954 36 24C36 25.1046 35.1046 26 34 26H26V34C26 35.1046 25.1046 36 24 36C22.8954 36 22 35.1046 22 34V26H14C12.8954 26 12 25.1046 12 24C12 22.8954 12.8954 22 14 22H22Z"
                        fill2="#B4E0FA"/>
